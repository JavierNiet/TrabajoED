...
public class Gato {
	...
	/**
	 * Pone a pelear a este gato contra otro.
	 * Gana el que tenga más peso.
	 * 
	 * @param contrincante El gato contra el que va a pelear
	 */
	public void pelear(Gato contrincante) {
		if (this.sexo == contrincante.getSexo()) {
			...
			System.out.println("Estos gatos no quieren pelear entre ellos.");
		}
	}
	...
	public String toString() {
		return "Gato [nombre = " + nombre + " , color = " + color + " , raza = " + raza + " , sexo = " + sexo
				+ " , peso = " + peso + "]";
